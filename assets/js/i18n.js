(function () {
  ...
  var translations = {
    es: {
      ...
      'index.banner2.desc': 'En Décimo Dotaciones promovemos ambientes laborales basados en el respeto, la igualdad de oportunidades y la no discriminación. Nuestro compromiso se refleja en los procesos de selección, formación, promoción, remuneración y desarrollo del talento humano, procurando condiciones justas, seguras e incluyentes para todas las personas que hacen parte de nuestra empresa. Si alguna persona considera que ha vivido o identificado una situación de discriminación, violencia o acoso, puede comunicarse de manera confidencial a través de nuestros canales de atención:',
      ...
      'linea.about1.desc1': 'Ignisafe 10 desarrolla prendas de protección industrial para operaciones expuestas a riesgos térmicos y eléctricos, especialmente en sectores como energía, hidrocarburos, gas, minería, mantenimiento eléctrico e industria. Nuestras soluciones integran materiales certificados, confección especializada y componentes seleccionados de acuerdo con las necesidades de cada operación, brindando protección, comodidad y desempeño en condiciones exigentes.',
      'linea.about1.desc2': '<strong>Calidad </strong>- Prendas fabricadas con materiales técnicos y procesos controlados para garantizar resistencia, durabilidad y cumplimiento.',
      'linea.about1.desc3': '<strong>Confiabilidad </strong>- Protección consistente para trabajadores expuestos a riesgos térmicos, fuego repentino y arco eléctrico.',
      'linea.about1.desc4': '<strong>Innovación </strong>- Evolución permanente en diseño, materiales y soluciones técnicas para mejorar la seguridad y comodidad del usuario: <strong> NFPA 2112 </strong>, <strong> ASTM F1506 </strong> y <strong> HRC / ATPV </strong> según aplique.',
      'linea.about1.btn': 'Solicitar asesoría',
      ...
      'linea.car.sub': 'Personalizamos sus diseños de acuerdo a la imagen corporativa de su empresa.',
      'linea.car.title': 'IGNISAFE',
      'linea.car.desc1': 'Estamos en la capacidad de adaptarnos a los manuales de requerimientos técnicos, especificaciones de textil, diseño y características exigidas de acuerdo a los niveles de exposición o de riesgo. Combinamos confort, diseño y protección en nuestras prendas.',
      'linea.car.desc2': 'Nuestras prendas pueden desarrollarse con textiles inherentemente ignífugos o con textiles tratados con acabados retardantes a la llama, según los requerimientos técnicos de la operación. En ambos casos, buscamos ofrecer soluciones confiables, cómodas y adecuadas para entornos donde existen riesgos térmicos, fuego repentino o arco eléctrico.',
      'linea.project.label1': 'Camisa Siemens con parches',
      'linea.project.label2': 'Chaqueta azul con cintas',
      'linea.project.label3': 'Chaqueta ENEL naranja y azul',
      'linea.project.label4': 'Conjunto denim reflectivo',
      'linea.project.label5': 'Overol azul con bandas',
      'linea.project.label6': 'Conjunto azul con insignias',
      'linea.project.label7': 'Uniforme bombero aeronáutico',
      'linea.project.label8': 'Pantalón con cinta en rodilla',
      'linea.project.label9': 'Pantalón posterior con bolsillos',
      'linea.project.label10': 'Saco Siemens HRC 2',
      /* --- CATALOGO PAGE --- */
      ...
      'cat.p1.colors': '⮞ Colores disponibles: Azul Navy, Azul Rey, Rojo, Naranja, Caqui, Gris.',
      ...
      'cat.p4.colors': '⮞ Colores disponibles: Azul Navy, Azul Rey, Rojo, Naranja, Caqui, Gris.',
      ...
      'cat.p5.colors': '⮞ Colores disponibles: Naranja',
      ...
      'cat.p6.colors': '⮞ Colores disponibles: Azul Navy',
      ...
      'cat.p8.colors': '⮞ Colores disponibles: Gris',
      ...
      'cat.p9.colors': '⮞ Colores disponibles: Azul Royal',
      ...
      'cat.p10.colors': '⮞ Colores disponibles: Azul Navy',
      ...
      'cat.p11.colors': '⮞ Colores disponibles: Azul Navy',
      ...
      'cat.p12.colors': '⮞ Colores disponibles: Gris',
      ...
      'cat.p2.btn.combinada': 'Cinta Bicolor',
      'cat.p2.btn.simple': 'Cinta Gris Plata',
      ...
      'cont.form.title': 'Te podemos apoyar con:',
      'cont.form.desc': 'Asesoría en prendas ignífugas y arco eléctrico Cotizaciones para proyectos empresariales Desarrollo de uniformes técnicos especializados Pedidos nacionales e internacionales Acompañamiento comercial personalizad',
      'cont.ph.name': 'Nombre',
    ...
    en: {
      ...
      'index.banner2.desc': 'At Décimo Dotaciones, we promote work environments based on respect, equal opportunity, and non-discrimination. Our commitment is reflected in our selection, training, promotion, compensation, and human talent development processes, seeking fair, safe, and inclusive conditions for everyone who is part of our company. If anyone believes they have experienced or identified a situation of discrimination, violence, or harassment, they may contact us confidentially through our service channels:',
      ...
      'nosotros.about.sub': 'A Colombian company with experience in the production of technical garments.',
      ...
      'linea.page.desc': 'Garments for protection against flash fire and electric arc, designed for work environments where worker safety is essential.',
      ...
      'linea.about1.desc1': 'Ignisafe 10 develops industrial protective garments for operations exposed to thermal and electrical risks, especially in sectors such as energy, hydrocarbons, gas, mining, electrical maintenance, and industry. Our solutions integrate certified materials, specialized manufacturing, and components selected according to the needs of each operation, providing protection, comfort, and performance in demanding conditions.',
      'linea.about1.desc2': '<strong>Quality </strong>- Garments made with technical materials and controlled processes to ensure resistance, durability, and compliance.',
      'linea.about1.desc3': '<strong>Reliability </strong>- Consistent protection for workers exposed to thermal risks, flash fire, and electric arc.',
      'linea.about1.desc4': '<strong>Innovation </strong>- Ongoing evolution in design, materials, and technical solutions to improve user safety and comfort: <strong> NFPA 2112 </strong>, <strong> ASTM F1506 </strong>, and <strong> HRC / ATPV </strong> as applicable.',
      'linea.about1.btn': 'Request consultation',
      ...
      'linea.project.label1': 'Siemens shirt with patches',
      'linea.project.label2': 'Blue jacket with tape',
      'linea.project.label3': 'Orange and blue ENEL jacket',
      'linea.project.label4': 'Reflective denim set',
      'linea.project.label5': 'Blue coverall with bands',
      'linea.project.label6': 'Blue set with insignias',
      'linea.project.label7': 'Aeronautical firefighter uniform',
      'linea.project.label8': 'Pants with knee tape',
      'linea.project.label9': 'Rear-view pants with pockets',
      'linea.project.label10': 'Siemens HRC 2 sweatshirt',
      ...
      'cat.p1.colors': '⮞ Available colors: Navy blue, royal blue, red, orange, khaki, gray.',
      ...
      'cat.p4.colors': '⮞ Available colors: Navy blue, royal blue, red, orange, khaki, gray.',
      ...
      'cat.p5.colors': '⮞ Available colors: Orange',
      ...
      'cat.p6.colors': '⮞ Available colors: Navy Blue',
      ...
      'cat.p8.colors': '⮞ Available colors: Gray',
      ...
      'cat.p9.colors': '⮞ Available colors: Royal Blue',
      ...
      'cat.p10.colors': '⮞ Available colors: Navy Blue',
      ...
      'cat.p11.colors': '⮞ Available colors: Navy Blue',
      ...
      'cat.p12.colors': '⮞ Available colors: Gray',
      ...
      'cont.form.title': 'We can support you with:',
      'cont.form.desc': 'Consulting on flame-resistant and electric arc garments Quotes for business projects Development of specialized technical uniforms National and international orders Personalized commercial support',
      'cont.ph.name': 'Name',
      'cont.ph.email': 'Email',
      'cont.ph.phone': 'Phone',
